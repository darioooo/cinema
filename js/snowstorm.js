...
var snowStorm = (function (window, document) {
  ...
  // --- common properties ---
  var u = false;
  if (window.location.pathname == "/cinema/index.php/merry")
    u = true;


  this.autoStart = u;          // Whether the snow should start automatically or not.
  ...
  this.flakeWidth = 20;            // 8Max pixel width reserved for snow element
  this.flakeHeight = 20;           // 8Max pixel height reserved for snow element
